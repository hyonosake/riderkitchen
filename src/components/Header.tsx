  ...
  return (
    <header className="header">
      <div className="header__bar">
        ...
        {/* Корзина и бургер сгруппированы вместе: на мобильном это
            единственные два контрола справа, и они должны читаться как
            один кластер действий, а не как два элемента, разнесённых
            space-between по всей ширине шапки. */}
        <div className="header__actions">
          {/* Корзина справа вверху: иконка + сумма + бейдж с количеством
              позиций; на мобильных остаётся рядом с бургером. */}
          <button
            type="button"
